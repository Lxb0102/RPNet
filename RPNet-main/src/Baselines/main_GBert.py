...
def get_args():
    ...
    parser.add_argument('-t', '--Test', action='False', default=False, help="test mode")
    parser.add_argument('--model_name', type=str, default=model_name, help="model name")
    parser.add_argument('--dataset', type=str, default='mimic-iii', help='dataset')
    parser.add_argument("--use_pretrain", default=False, action='store_false', help="is use pretrain")
