...
sys.path.append("..")
sys.path.append("../..")
sys.path.append(r'D:\code\RAREMed-main\src')
sys.path.append(r'D:\code\RAREMed-main')
from models.GAMENet import GAMENet
# sys.path.append(r'D:\code\RAREMed-main\src\utils')
...
def main(args):
    ...
    log_directory_path = os.path.join('D:\code\RAREMed-main\log', args.dataset, args.model_name)
    ...
    # load data
    data_path = f'D:\code\RAREMed-main/data/output/{args.dataset}' + '/records_final.pkl'
    voc_path = f'D:\code\RAREMed-main/data/output/{args.dataset}' + '/voc_final.pkl'
    ddi_adj_path = f'D:\code\RAREMed-main/data/output/{args.dataset}' + '/ddi_A_final.pkl'
    ehr_adj_path = f'D:\code\RAREMed-main/data/output/{args.dataset}' + '/ehr_adj_final.pkl'
